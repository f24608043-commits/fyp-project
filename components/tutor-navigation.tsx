...
import { LayoutDashboard, Calendar, Users, Video, User } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/tutor/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/tutor/sessions", label: "Sessions", icon: Calendar },
  { href: "/tutor/availability", label: "Availability", icon: Video },
  { href: "/tutor/learners", label: "Learners", icon: Users },
  { href: "/profile", label: "Profile", icon: User },
];

export const TutorMobileNavigation = () => {
...
export const TutorDesktopSidebar = () => {
  const pathname = usePathname();
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-muted h-screen fixed left-0 top-0 z-40">
      ...
      <div className="p-6 border-b border-muted">
        ...
        <p className="text-sm text-muted-foreground font-body">Tutor Portal</p>
      </div>
