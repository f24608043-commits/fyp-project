...
import { LayoutDashboard, Users, BookOpen, FileText, Award, Calendar, BarChart3, Settings } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/admin/admin-home", label: "Dashboard", icon: LayoutDashboard },
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-muted h-screen fixed left-0 top-0 z-40">
      ...
      <div className="p-6 border-b border-muted">
        ...
        <p className="text-sm text-muted-foreground font-body">Admin Portal</p>
      </div>
